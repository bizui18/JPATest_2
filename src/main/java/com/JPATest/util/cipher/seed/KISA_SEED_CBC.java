...
//                (byte)0x08, (byte)0x09, (byte)0x0A, (byte)0x0B, (byte)0x0C, (byte)0x0D, (byte)0x0E, (byte)0x0F};
		...
		logger.info("\n");
		logger.info("[ Test SEED reference code CBC]"+"\n");
		logger.info("\n\n");
		
		
		
		logger.info("[ Test Encrypt mode : 방법 1 ]"+"\n");
		logger.info("Key\t\t\t\t: ");
	    for (int i=0; i<16; i++)	logger.info(Integer.toHexString(0xff&pbUserKey[i])+" ");
	    logger.info("\n");
		logger.info("Plaintext\t\t\t: ");
	    for (int i=0; i<PLAINTEXT_LENGTH; i++)	logger.info(Integer.toHexString(0xff&pbData[i])+" ");
	    logger.info("\n");
	    ...
	    logger.info("\nIV\t\t\t\t: ");
	    for (int i=0; i<16; i++)
	    	logger.info(Integer.toHexString(0xff&bszIV[i])+" ");
	    logger.info("\n");
	    
		logger.info("Ciphertext(SEED_CBC_Encrypt)\t: ");
	    for (int i=0; i<CIPHERTEXT_LENGTH; i++)
	    	logger.info(Integer.toHexString(0xff&defaultCipherText[i])+" ");
	    logger.info("\n");
	    
	    logger.info("Plaintext(SEED_CBC_Decrypt)\t: ");
	    for (int i=0; i<PLAINTEXT_LENGTH; i++)
	    	logger.info(Integer.toHexString(0xff&PPPPP[i])+" ");
	    logger.info("\n\n");
		...
		logger.info("Ciphertext(SEED_CBC_Encrypt1)\t: ");
	    for (int i=0; i<16; i++)
	    	logger.info(Integer.toHexString(0xff&Cipher1[i])+" ");
	    logger.info("\n");
	    
	    logger.info("Plaintext(SEED_CBC_Decrypt1)\t: ");
	    for (int i=0; i<2; i++)
	    	logger.info(Integer.toHexString(0xff&Plain1[i])+" ");
	    logger.info("\n\n");
		...
		logger.info("Ciphertext(SEED_CBC_Encrypt)\t: ");
	    for (int i=0; i<32; i++)
	    	logger.info(Integer.toHexString(0xff&Cipher2[i])+" ");
	    logger.info("\n");
	    
	    logger.info("Plaintext(SEED_CBC_Decrypt)\t: ");
	    for (int i=0; i<16; i++)
	    	logger.info(Integer.toHexString(0xff&Plain2[i])+" ");
	    logger.info("\n\n\n");
		...
		logger.info("Ciphertext(SEED_CBC_Encrypt3)\t: ");
	    for (int i=0; i<32; i++)
	    	logger.info(Integer.toHexString(0xff&Cipher3[i])+" ");
	    logger.info("\n");
	    
	    logger.info("Plaintext(SEED_CBC_Decrypt3)\t: ");
	    for (int i=0; i<18; i++)
	    	logger.info(Integer.toHexString(0xff&Plain3[i])+" ");
	    logger.info("\n");
		...
		logger.info("Ciphertext(SEED_CBC_Encrypt 1)\t: ");
	    for (int i=0; i<CIPHERTEXT_LENGTH; i++)
	    	logger.info(Integer.toHexString(0xff&pbszCipherText[i])+", ");
	    logger.info("\n");
	    ...
	    logger.info("Plaintext(SEED_CBC_Decrypt 1)\t: ");
	    for (int i=0; i<PLAINTEXT_LENGTH; i++)
	    	logger.info(Integer.toHexString(0xff&result[i])+", ");
	    logger.info("\n\n");
