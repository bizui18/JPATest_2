...
@Getter
@Entity
@Table(name = "expctd_lotto_no")
public class ExpctdLottoNo {
	@Id
	...
	@Builder
	public ExpctdLottoNo(String drwtNo1, String drwtNo2, String drwtNo3, String drwtNo4, String drwtNo5, String drwtNo6, String crtDate) {
